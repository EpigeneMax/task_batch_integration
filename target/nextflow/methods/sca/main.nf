...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/sca/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/sca",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'iters': $( if [ ! -z ${VIASH_PAR_ITERS+x} ]; then echo "int(r'${VIASH_PAR_ITERS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/sca",
    "tag" : "build_main"
  },
  "label" : [
    "lowcpu",
