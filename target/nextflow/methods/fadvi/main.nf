...
meta = [
  ...
  "description" : "FADVI (Factor Disentanglement Variational Inference) is a deep learning method for single-cell omics and spatial transcriptomics analysis that disentangles batch-related variation, label-related variation, and residual variation using adversarial training and cross-correlation penalties.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/fadvi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'n_latent_l': $( if [ ! -z ${VIASH_PAR_N_LATENT_L+x} ]; then echo "int(r'${VIASH_PAR_N_LATENT_L//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_latent_b': $( if [ ! -z ${VIASH_PAR_N_LATENT_B+x} ]; then echo "int(r'${VIASH_PAR_N_LATENT_B//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'lambda_l': $( if [ ! -z ${VIASH_PAR_LAMBDA_L+x} ]; then echo "int(r'${VIASH_PAR_LAMBDA_L//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/fadvi",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
