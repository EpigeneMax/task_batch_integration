...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Build the pseudo-replicates per cell type, using obs['cell_type']. When false, scMerge2\nidentifies the cell groupings itself.\n",
          "default" : [
            false
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/scmerge2/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/scmerge2",
    "viash_version" : "0.9.4",
...
par <- list(
  ...
  "cell_type_aware" = $( if [ ! -z ${VIASH_PAR_CELL_TYPE_AWARE+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_CELL_TYPE_AWARE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
  "n_control_genes" = $( if [ ! -z ${VIASH_PAR_N_CONTROL_GENES+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_N_CONTROL_GENES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/scmerge2",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
