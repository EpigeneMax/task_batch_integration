...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "boolean",
          "name" : "--hvg_only",
          "description" : "Restrict the feature-space fit to var['hvg'] columns; pass through\nnon-HVG genes at the source's normalized value. Only applies when\n--rep=features.\n",
          "default" : [
            false
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Optional random subsample of data for constrained memory settings.",
          "default" : [
            1.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--mmd_size",
          "description" : "Number of samples used in each MMD evaluation (K_X in the paper).",
          "default" : [
            40
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--batch_size",
          "description" : "Number of MMD-loss evaluations per gradient step (K_Z in the paper).",
          "default" : [
            8
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--weight_decay",
          "description" : "AdamW weight decay applied to all model parameters (matrix/scale and\nbias/location).\n",
          "default" : [
            1.0E-5
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--patience",
          "description" : "Early-stopping patience (epochs without train-loss improvement\nbefore stopping).\n",
          "default" : [
            3
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--random_state",
          "description" : "Random seed for the adapter.",
          "default" : [
            42
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--device",
          "description" : "Torch device for the MMD training loop. Use 'cuda' or e.g. 'cuda:0'\nto run on GPU. Numpy preprocessing stays on CPU regardless.\n",
          "default" : [
            "cpu"
          ],
          "required" : false,
  ...
  "description" : "Confounded Domain Adaptation (ConDo) is a batch correction method that\nperforms a linear transformation of the features to match their\nconditional distribution given biological variables of interest. The\nintegrator walks a compatibility graph (batches sharing at least one\ncell type are connected), seeding at the batch with the highest\npre-integration silhouette of cell_type, and iteratively merges each\nbest-scoring neighbour by fitting one ConDo adapter conditioned on\ncell_type. Batches in disconnected components are passed through.\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/condo/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/condo",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'transform_type': $( if [ ! -z ${VIASH_PAR_TRANSFORM_TYPE+x} ]; then echo "r'${VIASH_PAR_TRANSFORM_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'rep': $( if [ ! -z ${VIASH_PAR_REP+x} ]; then echo "r'${VIASH_PAR_REP//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'hvg_only': $( if [ ! -z ${VIASH_PAR_HVG_ONLY+x} ]; then echo "r'${VIASH_PAR_HVG_ONLY//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'bootstrap_fraction': $( if [ ! -z ${VIASH_PAR_BOOTSTRAP_FRACTION+x} ]; then echo "float(r'${VIASH_PAR_BOOTSTRAP_FRACTION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'mmd_size': $( if [ ! -z ${VIASH_PAR_MMD_SIZE+x} ]; then echo "int(r'${VIASH_PAR_MMD_SIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'device': $( if [ ! -z ${VIASH_PAR_DEVICE+x} ]; then echo "r'${VIASH_PAR_DEVICE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/condo",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
