// scanorama_integrate build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/methods/scanorama_integrate/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/scanorama_integrate",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'dimred': $( if [ ! -z ${VIASH_PAR_DIMRED+x} ]; then echo "int(r'${VIASH_PAR_DIMRED//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/methods/scanorama_integrate",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
