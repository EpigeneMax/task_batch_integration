...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/data_processors/transform/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/data_processors/transform",
    "viash_version" : "0.9.4",
    "git_commit" : "8f95c9f7e496b053decc586882955a60f3433e6f",
...
par = {
  ...
  'input_dataset': $( if [ ! -z ${VIASH_PAR_INPUT_DATASET+x} ]; then echo "r'${VIASH_PAR_INPUT_DATASET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'expected_method_types': $( if [ ! -z ${VIASH_PAR_EXPECTED_METHOD_TYPES+x} ]; then echo "r'${VIASH_PAR_EXPECTED_METHOD_TYPES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/data_processors/transform",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
