// precompute_clustering_merge build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_batch_integration/task_batch_integration/src/data_processors/precompute_clustering_merge/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'clusterings': $( if [ ! -z ${VIASH_PAR_CLUSTERINGS+x} ]; then echo "r'${VIASH_PAR_CLUSTERINGS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_batch_integration/data_processors/precompute_clustering_merge",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
